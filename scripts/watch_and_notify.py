...
10:00・13:00・15:30 JSTに実行される想定（15:30は大引け(15:00 JST)後の
株価確定を受けたストップ高の当日中通知用。2026-09-17にユーザー要望で追加）。
...
def _stop_high_candidates(
    ...
    try:
        ...
        # 当日分を含めて取得する。株価四本値は大引け(15:00 JST頃)後にしか
        ...
        # 分（15:30 JST。.github/workflows/watch_and_notify.yml参照）で
